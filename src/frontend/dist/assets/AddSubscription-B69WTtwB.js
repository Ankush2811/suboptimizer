import { R as React2, j as jsxRuntimeExports, r as reactExports, n as React, o as reactDomExports, p as ReactDOM, u as useNavigate, f as useAddSubscription, t as todayISO, q as ue } from "./index-C2nV8s-d.js";
...
import { c as createContextScope, a as createSlot, P as Primitive, b as composeEventHandlers, d as dispatchDiscreteCustomEvent, u as useLayoutEffect2, e as useSize, f as useControllableState, g as usePrevious } from "./index-BGu_BhPC.js";
import { u as useComposedRefs, a as cn } from "./utils-CqG2ErZb.js";
import { C as Check, A as ArrowLeft } from "./check-QBRRyUFO.js";
...
const FEATURED = POPULAR_SUBSCRIPTIONS.filter(
  (s) => FEATURED_NAMES.includes(s.name)
);
const EMPTY_FORM = {
  name: "",
  emoji: "📋",
...
function AddSubscriptionPage() {
  ...
  const [selectedPopular, setSelectedPopular] = reactExports.useState(null);
  function prefillFromPopular(name) {
  ...
  function handleSubmit(e) {
    ...
    addSub(input, {
      onSuccess: () => {
        ue.success(`${input.name} added successfully!`);
        navigate({ to: "/home" });
      },
      onError: () => ue.error("Failed to add subscription. Please try again.")
    });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-4 pb-10", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display font-bold text-lg text-foreground", children: "Add Subscription" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "mb-6", "data-ocid": "add.popular_section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-sm text-foreground mb-3", children: "Popular Services" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-3 gap-3", children: FEATURED.map((sub, i) => {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            className: `relative flex flex-col items-center gap-2 p-3 rounded-2xl border transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring ${isSelected ? "border-primary bg-primary/5 shadow-elevated" : "border-border bg-card shadow-subtle hover:border-primary/40 hover:bg-secondary/60"}`,
            children: [
              isSelected && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute top-2 right-2 w-4 h-4 bg-primary rounded-full flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Check, { className: "w-2.5 h-2.5 text-primary-foreground" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  ...
                  role: "img",
                  "aria-label": sub.name,
                  children: sub.logoEmoji
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body font-medium text-xs text-foreground text-center leading-tight line-clamp-2 w-full", children: sub.name }),
              sub.monthlyPaise > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-body text-[10px] text-muted-foreground", children: [
                formatPaise(sub.monthlyPaise),
                "/mo"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Badge,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-body text-xs text-muted-foreground", children: "or add manually" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 h-px bg-border" })
    ] }),
        ...
        children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              Select,
              {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "rounded-xl", children: CATEGORIES.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: cat, children: cat }, cat)) })
                ]
              }
            )
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "absolute left-3 top-1/2 -translate-y-1/2 text-muted-foreground font-medium pointer-events-none", children: "₹" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  id: "sub-amount",
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    SelectTrigger,
                    {
                      ...
                      className: "rounded-xl",
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, { placeholder: "Select billing cycle" })
                    }
                  ),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { className: "rounded-xl", children: BILLING_CYCLES.map((cycle) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: cycle.value, children: cycle.label }, cycle.value)) })
                ]
              }
            )
          ] }),
...
export {
  AddSubscriptionPage as default
};
