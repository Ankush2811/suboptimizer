import { r as reactExports, j as jsxRuntimeExports, u as useNavigate, a as useSetOnboardingComplete } from "./index-C2nV8s-d.js";
...
function ProgressDots({ step, total }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: DOT_LABELS.slice(0, total).map((label, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          className: `rounded-full transition-smooth ${i === step ? "w-6 h-2 bg-primary" : "w-2 h-2 bg-border"}`
        },
        label
      ))
    }
...
function StepWelcome({ onNext }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center text-center gap-7", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-52 h-40 rounded-3xl gradient-primary relative overflow-hidden shadow-elevated flex items-center justify-center", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-6xl drop-shadow select-none relative z-10", children: "💡" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -bottom-6 -right-6 w-24 h-24 rounded-full bg-white/10" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute -top-4 -left-4 w-16 h-16 rounded-full bg-white/10" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 max-w-xs", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-display text-[1.75rem] font-bold text-foreground leading-tight", children: "Take control of your subscriptions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-[0.95rem] leading-relaxed", children: "Track everything you pay for. Stop paying for what you don't use." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
...
function StepBenefits({ onNext }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground", children: "Smart savings, simplified" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm", children: "Everything you need to stay on top of your subscriptions." })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: BENEFITS.map((b, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.div,
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-11 h-11 rounded-xl bg-secondary flex items-center justify-center text-xl flex-shrink-0 shadow-subtle", children: b.emoji }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: b.title }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5 leading-relaxed", children: b.desc })
          ] })
        ]
      },
      b.title
...
function StepSetup({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center space-y-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16 h-16 rounded-2xl bg-secondary flex items-center justify-center text-3xl mx-auto shadow-subtle", children: "📱" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display text-2xl font-bold text-foreground mt-2", children: "Auto-detect subscriptions?" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-sm max-w-xs mx-auto leading-relaxed", children: [
        "We can scan your SMS to find subscriptions automatically",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: " (coming soon)" }),
        "."
      ] })
    ] }),
      ...
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground text-sm", children: "SMS Detection" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs mt-0.5", children: "SMS Detection — Coming Soon" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Switch,
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-3 pt-3 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "inline-flex items-center gap-1.5 text-xs text-muted-foreground bg-muted rounded-full px-3 py-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-1.5 h-1.5 rounded-full bg-muted-foreground/40 inline-block" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          size: "lg",
          className: "w-full gradient-primary border-0 text-primary-foreground font-semibold text-base rounded-2xl shadow-elevated transition-smooth hover:opacity-90 h-[52px]",
          children: isPending ? "Setting up…" : "Start Saving 🎉"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center text-xs text-muted-foreground", children: "You can always enable this later in Settings." })
    ] })
  ] });
}
const TOTAL_STEPS = 3;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(circle, oklch(0.5 0.22 280 / 0.09), transparent 70%)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(circle, oklch(0.68 0.18 155 / 0.07), transparent 70%)"
                  }
                }
              )
            ]
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-[430px] min-h-screen flex flex-col px-6 pt-12 pb-10 relative z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end h-8 mb-6", children: step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 flex flex-col justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                step === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepWelcome, { onNext: handleNext }),
                step === 1 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepBenefits, { onNext: handleNext }),
                step === 2 && /* @__PURE__ */ jsxRuntimeExports.jsx(StepSetup, { onFinish: handleFinish, isPending })
              ]
            },
            step
          ) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-8 pb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProgressDots, { step, total: TOTAL_STEPS }) }),
