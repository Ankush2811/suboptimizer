import { i as commonjsGlobal, k as getDefaultExportFromCjs, r as reactExports, R as React2, l as invariant, m as useCategoryBreakdown, e as useOptimizationSuggestions, c as useTotalMonthlySpend, j as jsxRuntimeExports, L as Link } from "./index-C2nV8s-d.js";
import { c as createLucideIcon, p as paiseToRupees, L as Layout, f as formatPaise } from "./currency-imaPNYs2.js";
...
import { c as clsx } from "./utils-CqG2ErZb.js";
/**
  ...
  return _createClass$b(Pie2, [{
    ...
    value: function renderSectorsStatically(sectors) {
      ...
      return sectors.map(function(entry, i) {
        ...
        }), /* @__PURE__ */ React2.createElement(Shape, _extends$a({
    ...
    value: function renderLabelLineItem(option, props, key) {
      ...
      return /* @__PURE__ */ React2.createElement(Curve, _extends$a({}, props, {
        key,
        type: "linear",
        className
      }));
    ...
    value: function renderLabelItem(option, props, value) {
      ...
      return /* @__PURE__ */ React2.createElement(Text, _extends$a({}, props, {
...
var Brush = /* @__PURE__ */ function(_PureComponent) {
  ...
  return _createClass$a(Brush2, [{
    ...
    value: function renderText() {
      ...
      }, /* @__PURE__ */ React2.createElement(Text, _extends$9({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(startX, endX) - offset,
        y: y2 + height / 2
      }, attrs), this.getTextOfTick(startIndex)), /* @__PURE__ */ React2.createElement(Text, _extends$9({
        textAnchor: "start",
        verticalAnchor: "middle",
...
function BarRectangle(props) {
  return /* @__PURE__ */ React2.createElement(Shape, _extends$8({
    shapeType: "rectangle",
  ...
  return _createClass$9(Bar2, [{
    ...
    value: function renderBackground() {
      ...
      return data.map(function(entry, i) {
        ...
        return /* @__PURE__ */ React2.createElement(BarRectangle, _extends$7({
...
var renderLine = function renderLine2(option, props) {
  ...
  if (/* @__PURE__ */ React2.isValidElement(option)) {
    ...
    line = /* @__PURE__ */ React2.createElement("line", _extends$6({}, props, {
...
_defineProperty$8(ReferenceDot, "renderDot", function(option, props) {
  ...
  if (/* @__PURE__ */ React2.isValidElement(option)) {
    ...
    dot = /* @__PURE__ */ React2.createElement(Dot, _extends$5({}, props, {
      cx: props.cx,
      cy: props.cy,
...
_defineProperty$7(ReferenceArea, "renderRect", function(option, props) {
  ...
  if (/* @__PURE__ */ React2.isValidElement(option)) {
    ...
    rect = /* @__PURE__ */ React2.createElement(Rectangle, _extends$4({}, props, {
...
const SAMPLE_BREAKDOWN = [
  { category: "Entertainment", totalPaise: 175700n, count: 4n },
  { category: "Productivity", totalPaise: 43000n, count: 2n },
  { category: "Health", totalPaise: 24900n, count: 1n },
  { category: "Education", totalPaise: 9900n, count: 1n }
];
const SAMPLE_SUGGESTIONS = [
  {
    ...
    savingsPaise: 11900n,
    reason: "You have Amazon Prime which includes Amazon Music. Consider cancelling Spotify."
  },
  {
    subscriptionId: "4",
    ...
    savingsPaise: 24900n,
    reason: "You haven't opened Headspace in 30 days. Pause your subscription to save money."
  }
];
const MONTHLY_TREND = [
...
function PieTooltipContent({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border/60 rounded-xl px-3 py-2 shadow-elevated text-xs", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-semibold text-foreground", children: payload[0].name }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-savings font-bold", children: [
      "₹",
...
function CategoryLegend({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-2 mt-3", children: breakdown.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 min-w-0", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-foreground truncate", children: item.category }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Badge,
        {
          variant: "secondary",
          className: "text-[10px] px-1.5 py-0 h-4 flex-shrink-0",
          children: Number(item.count)
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-semibold text-foreground ml-2", children: formatPaise(item.totalPaise) })
  ] }, item.category)) });
}
...
function InsightsPage() {
  ...
  const { data: suggestions, isLoading: sugLoading } = useOptimizationSuggestions();
  const { data: totalSpend, isLoading: spendLoading } = useTotalMonthlySpend();
  const displayBreakdown = (breakdown == null ? void 0 : breakdown.length) ? breakdown : SAMPLE_BREAKDOWN;
  ...
  const totalSavingsPaise = displaySuggestions.reduce(
    (sum, s2) => sum + Number(s2.savingsPaise),
    0
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Layout, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 pt-6 pb-24", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-0.5", children: "Here's where your money goes" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-medium text-muted-foreground uppercase tracking-wide mb-1", children: "Total Monthly Spend" }),
          spendLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-9 w-32 mb-1" }) : /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-3xl text-foreground", children: formatPaise(displayTotal) }),
          totalSavingsPaise > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-semibold text-savings mt-1.5 flex items-center gap-1.5", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-[15px] text-foreground mb-4", children: "Spending by Category" }),
          bdLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-56 w-full rounded-xl" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-48", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(PieChart, { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Tooltip, { content: /* @__PURE__ */ jsxRuntimeExports.jsx(PieTooltipContent, {}) })
            ] }) }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CategoryLegend, { breakdown: displayBreakdown })
          ] })
        ]
      }
    ),
      ...
      "section",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-[15px] text-foreground", children: "6-Month Trend" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-44", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            BarChart,
            {
              data: MONTHLY_TREND,
              barCategoryGap: "30%",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Tooltip,
                  {
                    content: /* @__PURE__ */ jsxRuntimeExports.jsx(BarTooltipContent, {}),
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Bar,
                  {
                    ...
                    children: MONTHLY_TREND.map((entry, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Cell,
                      {
                        fill: i === MONTHLY_TREND.length - 1 ? "oklch(0.5 0.22 280)" : "oklch(0.5 0.22 280 / 0.45)"
                      },
                      entry.month
                    ))
                  }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground text-center mt-1", children: "Last 6 months spend trend" })
        ]
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { "data-ocid": "insights.suggestions_section", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-semibold text-[15px] text-foreground", children: "Smart Suggestions" })
      ] }) }),
      totalSavingsPaise > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Total savings potential" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-savings text-sm", children: [
              formatPaise(totalSavingsPaise),
              "/month"
            ] })
          ]
      ...
      sugLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: [1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "h-28 rounded-[14px]" }, i)) }) : displaySuggestions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground mb-1", children: "Your subscriptions look optimized!" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "No suggestions at this time. Keep it up!" })
          ]
        }
      ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-3", children: displaySuggestions.map((s2, i) => {
        const emoji = "logoEmoji" in s2 && s2.logoEmoji ? s2.logoEmoji : "💡";
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 mb-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-[10px] bg-secondary flex items-center justify-center text-lg flex-shrink-0", children: emoji }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-semibold text-sm text-foreground", children: s2.subscriptionName }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Badge,
                      {
                        variant: "secondary",
                        className: `text-[10px] capitalize px-2 py-0 h-[18px] ${SUGGESTION_BADGE[s2.suggestionType] ?? SUGGESTION_BADGE.cancel}`,
                        children: s2.suggestionType
                      }
                    )
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed mt-1", children: s2.reason })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-3 pt-2.5 border-t border-border/40", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm font-bold text-savings", children: [
                  "Save ",
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { children: [
                    formatPaise(s2.savingsPaise),
                    "/month"
                  ] })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
